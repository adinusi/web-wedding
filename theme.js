...
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
    ...
    //   });
      ...
      // tampilkan nama tamu
      var guestName = nusi.dataset.guest;
      ...
      var groupName = nusi.dataset.group;
      ...
      var copyText = function copyText(e, type = 'bank') {
        var newInp = document.createElement("input");
        newInp.autofocus = false;
        
        // Pastikan mengambil data dari elemen yang memicu event
        var target = e.currentTarget; 
        newInp.value = target.dataset.text; 
        ...
        // Ambil innerHTML dari elemen yang memicu event
        ...
        if(type == 'bank') {
          checkIcon = `
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#9EB996" class="size-6" style="width: 22px; margin-left: 5px;">
        ...
        setTimeout(function () {
            target.innerHTML = oldText; // Kembalikan teks asli setelah 2 detik
        }, 1500);
    }
    ...
    var nusi = document.getElementById("nusi");
    var lang = document.documentElement.lang;
      ...
      if (loader && nusi) {
        window.addEventListener("load", function () {
          setTimeout(function () {
            ...
            nusi.style.display = "block"; // Gunakan "block" bukan "inherit"
          }, 100);
        });
    ...
    var resizeWorkspace = function resizeWorkspace() {
      ...
      nusi.style.height = "".concat(newHeight, "px");
    ...
    // Detect slide
    var slides = document.querySelectorAll(".nusi_slide");
    var menus = document.querySelectorAll(".nusi_menu_item");
    var smMenu = document.getElementById("smMenu");
    var menuContainer = document.querySelector(".nusi_menu_list");
